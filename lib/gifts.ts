...
export type Theme = 'pink' | 'blue' | 'red';
...
export const giftRegistry: Record<string, GiftConfig> = {
    ...
    lidiya: {
        ...
        revealedDescription: 'Открийте пълния релакс с професионалния масажор на Lenovo. Проектиран за дълбоко мускулно възстановяване, този уред съчетава мощна перкусионна терапия с изключително тих двигател. Независимо дали след тренировка или просто имате нужда от момент за себе си, неговият ергономичен дизайн и прецизни настройки ще ви осигурят перфектното СПА изживяване навсякъде и по всяко време. Вашият път към пълното възстановяване започва тук! ✨',
